...
These are intended to be vision-capable and cheap enough for routine use. If we want to add a premium tier, candidates: `google/gemini-2.5-pro`, `anthropic/claude-sonnet-4.6`, `openai/gpt-4o`.
